...
public class Onlineshopping {
	public static void main(String[] args) {
		...
		System.out.println out.println("2. Customer Menu");
		...
		case 2: //Customer Module
			...
			System.out.println("4. View Orders"); System.out.println("5. View Products");
		...
		int productId = scanner.nextInt(); System.out.print("Enter Product Name: ");
		...
		System.out.print("Enter Product ID: "); int productId = scanner.nextInt();
		...
		private static void createAdmin(Scanner scanner) {
			...
			orderService.updateOrderStatus(orderld,status);
			}
private static void viewOrders() {
	...
	System.out.print("Enter Username: ");
	String username = scanner.next();
	System.out.print("Enter Email: "); String email scanner.next():
